...
- Improved error handling for unknown options and excess arguments
- Added proper validation for command arguments
...
- Added `expo-error-toast` to Expo ICP App Connect packages
- Added `expo-error-toast` to default installation packages
